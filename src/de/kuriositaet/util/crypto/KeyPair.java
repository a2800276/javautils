...
import static de.kuriositaet.util.crypto.Constants.*;
import static de.kuriositaet.util.crypto.Util.readAllClose;
...
public class KeyPair {
    ...
    public KeyPair(PrivateKey priv, PublicKey pub) {
        this.privKey = priv;
        if (pub.getJCAPublicKey().getAlgorithm() == "EC" && !(pub instanceof KeyPair.ECPublicKey)) {
