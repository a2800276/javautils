 ...
 * <p/>
 * <ul>
 * <li>{@link util.crypto.Hash.Algorithm Hash.Algorithm}</li>
 * <li>{@link util.crypto.KeyPair.Algorithm}</li>
 * <li>{@link util.crypto.Signature.Algorithm}</li>
 * </ul>
 ...
 * <ul>
 * <li>{@link util.crypto.Certificate#getX509Bytes}</li>
 * <li>{@link util.crypto.Certificate#getX509Bytes}</li>
 * <li>{@link util.crypto.KeyPair.PrivateKey#toPKCS8}</li>
 * <li>{@link util.crypto.KeyPair.PrivateKey#loadPKCS8}</li>
 * <li>{@link util.crypto.KeyPair.PublicKey#toX509}</li>
 * <li>{@link util.crypto.KeyPair.PublicKey#loadX509}</li>
 * <li>{@link util.crypto.KeyPair.ECPublicKey#toUncompressedCurvePoint}</li>
 * <li>{@link util.crypto.KeyPair.ECPublicKey#loadUncompressedCurvePoints}</li>
 * </ul>
 * <p/>
 * <h2>Caveat Emptor</h2>
 * <p/>
